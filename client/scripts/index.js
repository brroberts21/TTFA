...
function adminPageHeader(admin)
{
    ...
    const header = document.createElement("h2")
    header.textContent = `Welcome to the admin  portal, ${admin.ownerFirstName}!`
    header.style.color = "rgb(5,20,100)"
    container.appendChild(header)
...
function adminPageNavbar(admin)
{
    const appDiv = document.getElementById("app")
    appDiv.innerHTML = ""
    const navbar = document.createElement("nav")
...
async function handleOnAdmin(admin) {
    const app = document.getElementById("app"); 
    app.innerHTML = "";  
    ...
    addEventButton.className = "btn btn-primary mt-3";
    addEventButton.innerText = "Add Event";
    addEventButton.onclick = handleAddEvent;

    app.appendChild(addEventButton);
                ...
                <form onsubmit="handleAddEvent(event)">
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="eventStartTime" name="eventStartTime" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary w-100" id="main-btn">Event  account</button>
                </form>
                </div>
            </div>
        </div>
...
async function handleAddEvent(event){
    ...
    const evemtStartTime = document.getElementById("eventStartTime").value
